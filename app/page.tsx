      ...
      <section className="relative bg-gray-800 h-87.5 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 font-light">
            Desde 1993 unindo tradição, confiança e experiência.
          </p>
          <a
            href="#ofertas"
            className="inline-block bg-[#e30613] hover:bg-[#b3000a] text-white font-bold py-3 px-8 rounded-lg transition transform hover:scale-105 shadow-lg"
          >
            Ver Ofertas
          </a>
        </div>
      ...
      <div className="container mx-auto px-4 py-10">
        <div id="ofertas" className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Card 1: REDMAGIC 11 pro */}
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d] transition-transform hover:scale-105 duration-300">
              {/* Camada de brilho (fundo) */}
              <div className="absolute w-56 h-48 bg-white blur-[50px] -left-1/2 -top-1/2"></div>
              
              {/* Camada de conteúdo (fundo escuro interno + conteúdo) */}
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                <div className="w-full h-[160px] relative overflow-hidden rounded-lg bg-white mb-3">
                  <img 
                ...
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">REDMAGIC 11 pro</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 1.088,78</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 699,90</p>
                  <p className="text-xs text-gray-400 mb-3">à vista no Pix ou Boleto</p>
                  <button className="w-full bg-[#e30613] hover:bg-[#b3000a] text-white font-bold py-2 rounded transition">Ver Produto</button>
                </div>
              </div>
            </div>

            {/* Card 2: ROG Phone 9 Pro */}
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d] transition-transform hover:scale-105 duration-300">
              <div className="absolute w-56 h-48 bg-white blur-[50px] -left-1/2 -top-1/2"></div>
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                <div className="w-full h-[160px] relative overflow-hidden rounded-lg bg-white mb-3">
                ...
                <span className="text-xs text-gray-400 mb-1">Celulares</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">ROG Phone 9 Pro</h3>
                <div className="mt-auto w-full">
                  <p className="text-2xl font-bold text-[#e30613]">R$ 5.000</p>
                  <p className="text-xs text-gray-400 mb-3">Telefone topo de linha</p>
                  <button className="w-full bg-[#e30613] hover:bg-[#b3000a] text-white font-bold py-2 rounded transition">Ver Produto</button>
                </div>
              </div>
            </div>

            {/* Card 3: Parafusadeira */}
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d] transition-transform hover:scale-105 duration-300">
              <div className="absolute w-56 h-48 bg-white blur-[50px] -left-1/2 -top-1/2"></div>
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                <div className="w-full h-[160px] relative overflow-hidden rounded-lg bg-white mb-3">
                ...
                <span className="text-xs text-gray-400 mb-1">Ferramentas Elétricas</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">Parafusadeira de Impacto</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 1.200,00</p>
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d] transition-transform hover:scale-105 duration-300">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <span className="text-xs text-gray-400 mb-1">Ferramentas Elétricas</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">Betoneira Profissional</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 1.200,00</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 899,00</p>
                  <p className="text-xs text-gray-400 mb-3">À vista no Pix</p>
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d] transition-transform hover:scale-105 duration-300">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <span className="text-xs text-gray-400 mb-1">Ferramentas Elétricas</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">Betoneira Alta Performance</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 1.200,00</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 899,00</p>
                  <p className="text-xs text-gray-400 mb-3">À vista no Pix</p>
