          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d]">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 7.599,00</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 5.299,00</p>
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d]">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <span className="text-xs text-gray-400 mb-1">CELULARES</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">Sansung S24 ultra</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 10.499,00</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 9.974,05</p>
                  <p className="text-xs text-gray-400 mb-3">À vista no Pix</p>
                  <button className="w-full bg-[#e30613] hover:bg-[#b3000a] text-white font-bold py-2 rounded transition">Ver Produto</button>
                </div>
              </div>
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d]">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <span className="text-xs text-gray-400 mb-1">CELULARES</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">POCO X8 pro</h3>
                <div className="mt-auto w-full">
                  <p className="text-xs text-gray-500 line-through">R$ 6.999,99</p>
                  <p className="text-2xl font-bold text-[#e30613]">R$ 6.439,99</p>
                  <p className="text-xs text-gray-400 mb-3">À vista no Pix</p>
                  <button className="w-full bg-[#e30613] hover:bg-[#b3000a] text-white font-bold py-2 rounded transition">Ver Produto</button>
                </div>
              </div>
            ...
            <div className="relative drop-shadow-xl w-full h-96 overflow-hidden rounded-xl bg-[#333e1d]">
              ...
              <div className="absolute flex flex-col items-center justify-start text-white z- opacity-90 rounded-xl inset-0.5 bg-[#141414] p-4 h-full w-full">
                ...
                <span className="text-xs text-gray-400 mb-1">CELULARES</span>
                <h3 className="font-semibold text-sm leading-tight mb-2 flex-1">Iphone 17</h3>
                <div className="mt-auto w-full">
