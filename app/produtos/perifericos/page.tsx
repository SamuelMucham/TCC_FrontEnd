    ...
    async function carregarPerifericos() {
      try {
        ...
        if (Array.isArray(data)) {
          const apenasPerifericos = data.filter(
            (produto: Produto) =>
              produto.categoria?.toUpperCase() ===
              "PERIFÉRICO"
          );

          setProdutos(apenasPerifericos);
        } else {
          setProdutos([]);
        }
      } catch (error) {
        console.error(
          "Erro ao buscar periféricos:",
          error
        );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Encontre teclados, mouses, headsets,
            microfones e outros periféricos.
          </p>
        </div>
